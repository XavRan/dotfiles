	...
	{ -- Useful plugin to show you pending keybinds.
		...
		config = function() -- This is the function that runs, AFTER loading
			...
			require("which-key").register({
				...
				["<leader>y"] = { name = "[Y]ank to Clipboard", _ = "which_key_ignore" },
				["<leader>p"] = { name = "[P]aste Clipboard", _ = "which_key_ignore" },
			})
		end,
	},
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set(
				...
				{ desc = "[S]earch [C]urrent buffer fuzzily" }
			)
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					-- Mappings for LSP related items. It sets the mode, buffer and description for us each time.
